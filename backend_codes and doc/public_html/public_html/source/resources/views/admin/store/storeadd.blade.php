            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Store Profile</h4>
                </div>
                <div class="card-body">
                  <form class="forms-sample" action="{{route('storeadd')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Store Number</label>
                     ...
                     <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="number" name="range" class="form-control" placeholder="Delivery Range in KM">
                        </div>
                      </div>
                    </div><br>
                         <div class="row">                    

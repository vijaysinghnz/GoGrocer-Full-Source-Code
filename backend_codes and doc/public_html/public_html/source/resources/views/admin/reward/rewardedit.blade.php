            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Edit Rewards Points</h4>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <p class="card-description">Cart Value</p>
                          <input type="hidden" name="reward_id"  value="{{$reward->reward_id}}">
                          <input type="text" name="min_cart_value" value="{{$reward->min_cart_value}}" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="reward_points" value="{{$reward->reward_point}}" class="form-control">
                        </div>
                      </div>
                    </div>
